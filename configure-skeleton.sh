...
vendor_name_unsantized=$(ask_question "Vendor name" "get-things-done")
vendor_name_camelcase=$(ask_question "Vendor namespace" "GetThingsDone")
...
echo -e "Namespace: $vendor_name_camelcase\\$class_name"
...
echo
files=$(grep -E -r -l -i ":author|:vendor|:package|get-things-done|skeleton" --exclude-dir=vendor ./*  | grep -v "$script_name")
...
for file in $files ; do
    ...
    | sed "s/GetThingsDone/$vendor_name_camelcase/g" \
